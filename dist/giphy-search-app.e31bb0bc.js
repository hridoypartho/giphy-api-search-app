...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/debounce/index.js":[function(require,module,exports) {
/**
...
var API_KEY = "o3kDK7wDnCgmt56fOs7qd1xMxQkw8pGX";
var COUNT = 10;
var OFFSET = 0;
...
var getData = function getData() {
  ...
  var URL = "https://api.giphy.com/v1/gifs/search?api_key=".concat(API_KEY, "&q=").concat(searchText, "&limit=").concat(COUNT, "&offset=").concat(OFFSET, "&rating=g&lang=en");

  _axios.default.get(URL).then(function (response) {
    root.innerHTML = "";
    response.data.data.forEach(function (dataItme) {
      var div = document.createElement("div");
      div.classList.add("item"); // data[0].images.original.url

      div.style.background = "url(".concat(dataItme.images.original.url, ") no-repeat");
...
getData();
var debounceGetData = (0, _debounce.default)(getData, 400);
...
var previousBtn = btnContainer.querySelector(".previous");
var nextBtn = btnContainer.querySelector(".next");
...
},{"axios":"node_modules/axios/index.js","debounce":"node_modules/debounce/index.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/giphy-search-app.e31bb0bc.js.map